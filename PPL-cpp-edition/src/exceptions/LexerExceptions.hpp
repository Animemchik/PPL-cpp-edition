...
class InvalidCharLiteralE : public LexerE {
public:
    InvalidCharLiteralE(string& code, string& filename, int row, int col);
    const string What() const override;
};

class EmptyCharE : public LexerE {
public:
    EmptyCharE(string& code, string& filename, int row, int col);
    const string What() const override;
};

class CharNotCompleteE : public LexerE {
public:
    CharNotCompleteE(string& code, string& filename, int row, int col);
    const string What() const override;
};
